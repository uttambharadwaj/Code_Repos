...
function pageLoadFunctions() {
    ...
    if($Label.Language_Code != null && ($Label.Language_Code === 'en_ca' || $Label.Language_Code == 'fr_ca'))
{
flipToProvince
(
'physicalState'
...
'CustomerConversionController.validatePreviousAccountNumber',
...
nextStep();
    ...
    $j('[id$=previousAccountNumber]').addClass('erroredInput').after('<div class="fieldErrorMessage filled" style="padding-top: 3px; padding-bottom: 3px;">'+$Label.Account_Number_Error+'</div>');
