...
({
    cacheFinesseLogin: function(component){

        var username = component.get('v.username');
        var password = component.get('v.password');

        console.log('### Debug: Helper: Cache User Data username:' + username + '  pass: ' + password);

        var action = component.get("c.cacheFinesseLogin");
