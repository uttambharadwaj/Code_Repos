...
<CustomApplication xmlns="http://soap.sforce.com/2006/04/metadata">
    <consoleConfig>
        ...
        <footerColor>#333333</footerColor>
        <headerColor>#333333</headerColor>
        <keyboardShortcuts>
            <defaultShortcuts>
        ...
        <liveAgentConfig>
            ...
            <pageNamesToOpen>i2iSearchPage</pageNamesToOpen>
            <showKnowledgeArticles>false</showKnowledgeArticles>
        </liveAgentConfig>
        <primaryTabColor>#3A97B5</primaryTabColor>
    </consoleConfig>
    <defaultLandingTab>standard-home</defaultLandingTab>
    <isNavAutoTempTabsDisabled>false</isNavAutoTempTabsDisabled>
    <isNavPersonalizationDisabled>false</isNavPersonalizationDisabled>
    <isServiceCloudConsole>true</isServiceCloudConsole>
    <label>Inside Sales Console Live Agent</label>
    <preferences>
    ...
    <workspaceConfig>
        ...
        <mappings>
            <tab>Daily_Transaction_Monitoring_Report</tab>
        </mappings>
        <mappings>
            <tab>Event__c</tab>
        </mappings>
