...
<CustomMetadata xmlns="http://soap.sforce.com/2006/04/metadata" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema">
    <label>GIACT_VerificationResponse0</label>
    ...
    <values>
        ...
        <value xsi:type="xsd:string">There was an error with the inquiry. Check the ErrorMessage property for details.</value>
    </values>
    <values>
